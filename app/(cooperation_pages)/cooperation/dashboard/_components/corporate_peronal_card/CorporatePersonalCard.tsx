import { useCompanyData, useUserData } from '@/components/data/dataFether';
...
export default function CorporatePersonalCard() {

  const { data: userData } = useCompanyData();
    ...
    <div className='w-[260px] h-[700px] bg-white rounded-lg border p-8'>
      ...
      <div className='relative flex flex-col gap-5 items-center mt-10'>
        ...
        <div className='text-center'>
          <h2>{userData?.name} <span className='font-bold'></span></h2>
